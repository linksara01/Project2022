...
const Product = ({ fish }) => {
  const [price, setPrice] = useState(fish.prices[0]);
  ...
  const handleSize = (sizeIndex) => {
    const difference = fish.prices[sizeIndex] - fish.prices[size];
    setSize(sizeIndex);
  ...
  const handleClick =() =>{
    dispatch(addProduct({...fish,extras,price,quantity}));
  };
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.right}>
        ...
        <span className={styles.price}>{price} บาท </span>
